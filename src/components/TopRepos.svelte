<script>
  ...
  const sliced_description = (str) => {
    if (str.length > 100) return str.splice(0, 100);
    else return str;
  };
  let v = "";
</script>
...
<div class="container pt-4">
        ...
        <div class="card-content">
          ...
          <div class="content">
            <Chart
              data={chartData}
              type="percentage"
              maxSlices={chartData.labels.length}
            />
          </div>
        </div>
      </div>
    ...
    <div class="column is-6">
      <div class="card">
        <div class="card-content">
          ...
          <div class="content">
            <Chart
              data={languageStarsChart}
              type="percentage"
              maxSlices={languageStarsChart.labels.length}
            />
          </div>
        </div>
      </div>
  ...
  <h2 class="title has-text-white" style="text-align: center;">Top Repos</h2>
...
<nav class="navbar mt-5" role="navigation" aria-label="main navigation">
  <div id="navbarBasicExample" class="navbar-menu">
    <div class="navbar-start">
      <a class="navbar-item" href="https://bulma.io/"> Powered By : </a>
    ...
    <div class="navbar-end">
      <div class="navbar-item">
        <div class="buttons">
          <a
            href="https://github.com/Ansh-Sarkar"
          ...
          <a
            href="https://www.linkedin.com/in/ansh-sarkar/"
            class="button is-primary"
            target="_blank"
          >
