<script>
  ...
  const displayCompany = () => {
    if (user.company == null) return " | " + " No Current Job " + " | ";
...
<header class="profile pt-7">
  ...
  <h1 class="title mt-7 has-text-white">{user.name}</h1>
  <p class="subtitle has-text-white">
    <u>
      <a class="has-text-white" href={user.html_url}>
        {user.login}
      </a>
    </u>
  </p>
  <div class="subtitle has-text-white">
    ...
    <div class="pt-2">
      <svg
        ...
        /></svg
      >
      {displayCompany()} <span class="pl-4" />
      <svg
        aria-hidden="true"
        class="octicon"
        height="16"
        ...
        /></svg
      >
      {displayLocation()} <span class="pl-4" />
      <svg
        aria-hidden="true"
        class="octicon"
        height="16"
  ...
  <div class="cards pt-4">
    <div class="card">
      <div class="card-content">
        ...
        <p>{"Repositories".toUpperCase()}</p>
      </div>
    </div>
    <div class="card ml-2">
      <div class="card-content">
        <span>{user.followers}</span>
        <p>{"Followers".toUpperCase()}</p>
      </div>
    </div>
    <div class="card ml-2">
      <div class="card-content">
